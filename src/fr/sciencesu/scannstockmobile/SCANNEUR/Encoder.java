...
public final class Encoder {
	...
	public static void encode(String content, ErrorCorrectionLevel ecLevel,
		...
		qrCode.setMaskPattern(chooseMaskPattern(finalBits, ecLevel,
				qrCode.getVersion(), matrix));

		// Step 8. Build the matrix and set it to "qrCode".
		MatrixUtil.buildMatrix(finalBits, ecLevel, qrCode.getVersion(),
	...
	private static int getTotalInputBytes(int numInputBits, Version version,
			Mode mode) {
		int modeInfoBits = 4;
