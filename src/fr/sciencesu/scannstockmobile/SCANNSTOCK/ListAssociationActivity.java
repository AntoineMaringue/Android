...
public class ListAssociationActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list.setAdapter(new ArrayAdapter<String>(ListAssociationActivity.this,
				android.R.layout.simple_list_item_1, associations));
		list.setOnItemClickListener(new AdapterView.OnItemClickListener() {

			public void onItemClick(AdapterView<?> av, View view, int i, long l) {
				Toast.makeText(ListAssociationActivity.this, "Position " + i,
						Toast.LENGTH_SHORT).show();
				// Intent x = new
				// Intent(ListAssociationActivity.this,ConnexionActivity.class);
